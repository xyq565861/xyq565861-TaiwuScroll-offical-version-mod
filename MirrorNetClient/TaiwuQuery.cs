...
namespace MirrorNet
{
    public class TaiwuQuery
    {
        ...
        //    }
        //}
        public TaiwuQueryImpl ProtocolDataUnit()
        {

                return _taiwuQueryImpl;
        ...
        public void TryFormate(byte[] buffer)
        {
            object obj = UilityTools.ByteArrayToObject(buffer);
            TaiwuQueryImpl impl = obj as TaiwuQueryImpl;
            _taiwuQueryImpl = impl;
        }
